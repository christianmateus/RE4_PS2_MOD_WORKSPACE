...
- **Visual Editor**
  ...
  - Edição de AEV, ESL, ETS, colisões, LIT, EFF, RTP e CAM
  - Seleção, transformação, duplicação, exclusão e edição de propriedades
  - Auto-save, Undo/Redo e persistência da câmera e navegação
- Editores de inimigos, personagens, animações FCV e mensagens MDT
...
- **Visual Editor**
  ...
  - Editing for AEV, ESL, ETS, collision, LIT, EFF, RTP and CAM data
  - Selection, transformation, duplication, deletion and property editing
  - Auto-save, Undo/Redo and persistent camera/navigation settings
- Enemy, character, FCV animation and MDT message editors
